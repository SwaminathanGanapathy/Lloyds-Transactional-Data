...
package lloyds_banking.customer_to_customer_0_1;
...
/**
 * Job: Customer_to_Customer Purpose: To extract the customer to customer transactions from the original data<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Customer_to_Customer implements TalendJob {
...
public java.lang.String getMySQL_Password(){
	...
	private final String jobName = "Customer_to_Customer";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Customer_to_Customer.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Customer_to_Customer.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
query_tDBRow_2 = "create table lloyds_banking.cus_group (from_totally_fake_account varchar(100), to_randomnly_generated_account varchar(1"
+"00), Number_of_Transaction int, Total_Amount int); ";
...
query_tDBRow_1 = "insert into lloyds_banking.cus_group (select from_totally_fake_account, to_randomnly_generated_account, count(monopoly_"
+"money_amount) as Number_of_Transaction, sum(monopoly_money_amount) as Total_Amount from lloyds_banking.cclloyds group by"
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		lloyds_banking.customer_to_business_0_1.Customer_to_Business childJob_tRunJob_1 = new lloyds_banking.customer_to_business_0_1.Customer_to_Business();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Customer_to_Customer Customer_to_CustomerClass = new Customer_to_Customer();

        int exitCode = Customer_to_CustomerClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer_to_Customer.class.getClassLoader().getResourceAsStream("lloyds_banking/customer_to_customer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Customer_to_Customer.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Customer_to_Customer");
        }
...
/************************************************************************************************
 *     51702 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 March 2023 at 7:51:37 PM GMT
 ************************************************************************************************/