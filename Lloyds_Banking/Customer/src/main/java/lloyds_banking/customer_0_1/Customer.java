...
package lloyds_banking.customer_0_1;
...
query_tDBRow_1 = "create table lloyds_banking.cclloyds (from_totally_fake_account varchar(100), monopoly_money_amount float, to_randomnly"
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LLOYDS_BANKING_Customer = new byte[0];
    static byte[] commonByteArray_LLOYDS_BANKING_Customer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LLOYDS_BANKING_Customer.length) {
				if(length < 1024 && commonByteArray_LLOYDS_BANKING_Customer.length == 0) {
   					commonByteArray_LLOYDS_BANKING_Customer = new byte[1024];
				} else {
   					commonByteArray_LLOYDS_BANKING_Customer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LLOYDS_BANKING_Customer, 0, length);
			strReturn = new String(commonByteArray_LLOYDS_BANKING_Customer, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LLOYDS_BANKING_Customer, 0, length);
			strReturn = new String(commonByteArray_LLOYDS_BANKING_Customer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LLOYDS_BANKING_Customer) {
...
String tableName_tDBOutput_1 = "cclloyds";
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "cclloyds" + "` (`from_totally_fake_account`,`monopoly_money_amount`,`to_randomnly_generated_account`,`not_happened_yet_date`,`day_`,`month_`,`year_`) VALUES (?,?,?,?,?,?,?)";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "/home/ec2-user/C-CLloyds.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("/home/ec2-user/C-CLloyds.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)("/home/ec2-user/C-CLloyds.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		lloyds_banking.business_0_1.Business childJob_tRunJob_1 = new lloyds_banking.business_0_1.Business();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer.class.getClassLoader().getResourceAsStream("lloyds_banking/customer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     77353 characters generated by Talend Open Studio for Data Integration 
