...
package lloyds_banking.customer_to_business_0_1;
...
/**
 * Job: Customer_to_Business Purpose: To extract the customer to business transactions from the original data<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Customer_to_Business implements TalendJob {
...
public java.lang.String getMySQL_Password(){
	...
	private final String jobName = "Customer_to_Business";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Customer_to_Business.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Customer_to_Business.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
query_tDBRow_2 = "create table lloyds_banking.bus_group (from_totally_fake_account varchar(100), to_randomnly_generated_account varchar(1"
...
query_tDBRow_1 = "insert into lloyds_banking.bus_group (select from_totally_fake_account, to_randomnly_generated_account, count(monopoly_"
+"money_amount) as Number_of_Transaction, sum(monopoly_money_amount) as Total_Amount from lloyds_banking.cblloyds group by"
 ...
 */
    ...
    public static void main(String[] args){
        final Customer_to_Business Customer_to_BusinessClass = new Customer_to_Business();

        int exitCode = Customer_to_BusinessClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer_to_Business.class.getClassLoader().getResourceAsStream("lloyds_banking/customer_to_business_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Customer_to_Business.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Customer_to_Business");
        }
...
/************************************************************************************************
 *     44497 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 March 2023 at 7:51:23 PM GMT
 ************************************************************************************************/