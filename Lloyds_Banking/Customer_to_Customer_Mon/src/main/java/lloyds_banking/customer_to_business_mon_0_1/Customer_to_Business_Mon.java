...
package lloyds_banking.customer_to_business_mon_0_1;
...
/**
 * Job: Customer_to_Business_Mon Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Customer_to_Business_Mon implements TalendJob {
...
public java.lang.String getMySQL_Password(){
	...
	private final String jobName = "Customer_to_Business_Mon";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Customer_to_Business_Mon.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Customer_to_Business_Mon.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
query_tDBRow_2 = "create table lloyds_banking.bus_group_mon (from_totally_fake_account varchar(100), to_randomnly_generated_account varch"
...
query_tDBRow_1 = "insert into lloyds_banking.bus_group_mon (select from_totally_fake_account, to_randomnly_generated_account, month_, cou"
+"nt(monopoly_money_amount) as Number_of_Transaction, sum(monopoly_money_amount) as Total_Amount from lloyds_banking.cbllo"
 ...
 */
    ...
    public static void main(String[] args){
        final Customer_to_Business_Mon Customer_to_Business_MonClass = new Customer_to_Business_Mon();

        int exitCode = Customer_to_Business_MonClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer_to_Business_Mon.class.getClassLoader().getResourceAsStream("lloyds_banking/customer_to_business_mon_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Customer_to_Business_Mon.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Customer_to_Business_Mon");
        }
...
/************************************************************************************************
 *     44512 characters generated by Talend Open Studio for Data Integration 
