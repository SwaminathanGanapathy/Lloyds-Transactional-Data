...
package lloyds_banking.customer_to_customer_mon_0_1;
...
/**
 * Job: Customer_to_Customer_Mon Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Customer_to_Customer_Mon implements TalendJob {
...
public java.lang.String getMySQL_Password(){
	...
	private final String jobName = "Customer_to_Customer_Mon";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Customer_to_Customer_Mon.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Customer_to_Customer_Mon.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
        ...
        String properties_tDBConnection_2 = context.MySQL_AdditionalParams;
        ...
        String url_tDBConnection_2 = "jdbc:mysql://" + context.MySQL_Server + ":" + context.MySQL_Port + "/" + context.MySQL_Database + "?" + properties_tDBConnection_2;
	String dbUser_tDBConnection_2 = context.MySQL_Login;
	
	
		
	final String decryptedPassword_tDBConnection_2 = context.MySQL_Password; 
	...
	globalMap.put("db_tDBConnection_2",context.MySQL_Database);
...
query_tDBRow_2 = "create table lloyds_banking.cus_group_mon (from_totally_fake_account varchar(100), to_randomnly_generated_account varch"
+"ar(100), month_ int, Number_of_Transaction int, Total_Amount int); ";
...
query_tDBRow_1 = "insert into lloyds_banking.cus_group_mon (select from_totally_fake_account, to_randomnly_generated_account, month_, cou"
+"nt(monopoly_money_amount) as Number_of_Transaction, sum(monopoly_money_amount) as Total_Amount from lloyds_banking.ccllo"
+"yds group by 1,2,3\norder by from_totally_fake_account);";
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		lloyds_banking.customer_to_business_mon_0_1.Customer_to_Business_Mon childJob_tRunJob_1 = new lloyds_banking.customer_to_business_mon_0_1.Customer_to_Business_Mon();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Customer_to_Customer_Mon Customer_to_Customer_MonClass = new Customer_to_Customer_Mon();

        int exitCode = Customer_to_Customer_MonClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer_to_Customer_Mon.class.getClassLoader().getResourceAsStream("lloyds_banking/customer_to_customer_mon_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Customer_to_Customer_Mon.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Customer_to_Customer_Mon");
        }
...
/************************************************************************************************
 *     51733 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 March 2023 at 7:51:27 PM GMT
 ************************************************************************************************/